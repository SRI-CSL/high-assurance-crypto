...
module type MultiplicationGateEvalData = sig
...
module MultiplicationGateData
         (SSD : sig include SecretSharingSchemeData with type secret_t = t end)
         (AGED : sig include MultiplicationGateEvalData with type pid_t = SSD.pid_t and
...
module MultiplicationGate
         (SSD : sig include SecretSharingSchemeData with type secret_t = t end)
         (AGED : sig include MultiplicationGateEvalData with type pid_t = SSD.pid_t and
                                                       type pinput_t = unit and
                                                       type sinput_t = SSD.share_t and
                                                       type output_t = SSD.secret_t and
                                                       type poutput_t = SSD.share_t end) = Gate (MultiplicationGateData (SSD) (AGED))
