...
Lkeccak1600_avx2$16:
	...
	vpblendd	$51, %ymm0, %ymm1, %ymm0
	vpxor	%ymm5, %ymm9, %ymm9
	vpblendd	$15, %ymm7, %ymm6, %ymm1
...
Lkeccak1600_avx2$17:
	...
	leaq	32(%r13), %r13
	decl	%r14d
	jne 	Lkeccak1600_avx2$17
Lkeccak1600_avx2$15:
	cmpq	%r8, %rcx
	jnb 	Lkeccak1600_avx2$16
...
Lkeccak1600_avx2$13:
	cmpq	%rbx, %r12
	jb  	Lkeccak1600_avx2$14
	movq	(%r9,%r12,8), %rbx
	shlq	$3, %rbx
	shlq	$3, %r12
	jmp 	Lkeccak1600_avx2$11
Lkeccak1600_avx2$12:
	movb	(%rdx,%r12), %r13b
	movb	%r13b, (%rsp,%rbx)
	leaq	1(%r12), %r12
...
Lkeccak1600_avx2$8:
	cmpq	%rax, %rcx
	jb  	Lkeccak1600_avx2$9
	leaq	(%rdi,%r8), %rdi
	subq	%r8, %rsi
Lkeccak1600_avx2$6:
	cmpq	%r8, %rsi
	jnbe	Lkeccak1600_avx2$7
	leaq	96(%r10), %rax
	leaq	96(%r11), %rcx
	movl	$24, %edx
	.p2align	5
...
Lkeccak1600_avx2$3:
	cmpq	%rax, %rcx
	jb  	Lkeccak1600_avx2$4
	movq	(%r9,%rcx,8), %rax
	shlq	$3, %rcx
	shlq	$3, %rax
	jmp 	Lkeccak1600_avx2$1
Lkeccak1600_avx2$2:
	movb	(%rsp,%rax), %dl
	movb	%dl, (%rdi,%rcx)
	leaq	1(%rcx), %rcx
