...
let _ = dispatch begin function
  ...
  | After_rules ->
      ...
      let buildDir = (!Options.build_dir) in

      flag ["link";"ocaml";"use_shake128"];
      dep ["link";"ocaml";"use_shake128"] ["shake128-m.o"];
      dep ["link";"ocaml";"use_shake128"] ["sha3.o"];

      flag ["link";"ocaml";"use_maurer"] (S[A"-cclib"; A(buildDir ^ "/../MPC.s");]);
      dep ["link";"ocaml";"use_maurer"] ["maurer.o"] ;
