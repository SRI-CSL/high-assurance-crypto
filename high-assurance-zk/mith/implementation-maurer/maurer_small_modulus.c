...
extern void input_start5(uint64_t, uint64_t*,uint64_t*,uint64_t*);
extern uint64_t  input_end5(uint64_t, uint64_t*,uint64_t*,uint64_t);

extern void const_start5(uint64_t, uint64_t*,uint64_t*);
extern uint64_t const_end5(uint64_t, uint64_t*,uint64_t*,uint64_t);
extern uint64_t Smult5(uint64_t, uint64_t*,uint64_t,uint64_t,uint64_t);

extern uint64_t add5(uint64_t, uint64_t*,uint64_t,uint64_t,uint64_t);

extern void mult_start5(uint64_t, uint64_t*,uint64_t,uint64_t,uint64_t*,uint64_t*);
extern uint64_t mult_end5(uint64_t, uint64_t*,uint64_t*,uint64_t);

extern void out_start5(uint64_t, uint64_t*,uint64_t,uint64_t*);
extern void out_end5(uint64_t, uint64_t*,uint64_t*,uint64_t);
...
uint64_t FIELD = 101;
CAMLprim value init_modulus(value modulus){
  CAMLparam1(modulus);
  FIELD = Long_val (modulus);
...
CAMLprim value initial_status_c (value pidv, value n_inputs, value inputs) {
  ...
  for (int i = 0; i < n_inputs_c; i++) {
     ...
     input_end5(FIELD,share, status, i);
  }
...
CAMLprim value maurer_share_c(value rands, value pinp) {
  ...
  input_start5(FIELD,input, msgs_c, rands_c);
...
CAMLprim value maurer_add_c (value wl, value wr, value wst) {
  ...
  add5(FIELD,status_c,wl_c,wr_c,wire_count_c);
...
CAMLprim value maurer_smul_c (value wl, value wr, value wst) {
  ...
  Smult5(FIELD,status_c,wl_c,wr_c,wire_count_c);
...
CAMLprim value maurer_const_c (value sec, value wst, value pid) {
  ...
  const_start5(FIELD,input, msgs);
    
  const_end5(FIELD,msgs+pid_c*shareSize, status_c, wire_count_c);
...
CAMLprim value maurer_mul_start_c (value wl, value wr, value wst, value r) {
  ...
  mult_start5(FIELD,status_c, wl_c, wr_c, r_c + randSharingSize, r_c);
...
CAMLprim value maurer_mul_end_c (value msgs, value wst) {
  ...
  mult_end5(FIELD,msgs_c, status_c, wire_count_c);
...
CAMLprim value maurer_output_start_c (value wid, value wst) {
  ...
  out_start5(FIELD,status_c, wid_c, msgs);
...
CAMLprim value maurer_output_end_c (value msgs) {
  ...
  out_end5(FIELD,msgs_c, output, -1);
