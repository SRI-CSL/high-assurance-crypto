...
theory InputGate.
  ...
  clone import InputFunctionality.
  ...
  clone import Gate with
    ...
    type GateFunctionality.pinput_t = InputFunctionality.GateFunctionality.pinput_t,
    type GateFunctionality.sinput_t = InputFunctionality.GateFunctionality.sinput_t,
    op GateFunctionality.valid_inputs = InputFunctionality.GateFunctionality.valid_inputs,
    type GateFunctionality.output_t = InputFunctionality.GateFunctionality.output_t,
    op GateFunctionality.f = InputFunctionality.GateFunctionality.f,
