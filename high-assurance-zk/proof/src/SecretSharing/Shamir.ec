...
theory Shamir.
  ...
  qed.
  realize size_share.
    by rewrite /share /= => *; rewrite size_map pid_set_size.
  qed.
  realize unzip1_share.
    by rewrite /share /= => *; rewrite -map_comp /(\o) /= map_id.
  qed.
  realize size_public_encoding.
    by rewrite /public_encoding /= => *; rewrite size_map pid_set_size.
  qed.
  ...
  qed.
  realize public_encoding_rand. admit. qed.

  clone import SecretSharingSchemeSecurity with theory SecretSharingScheme <- SecretSharingScheme.
