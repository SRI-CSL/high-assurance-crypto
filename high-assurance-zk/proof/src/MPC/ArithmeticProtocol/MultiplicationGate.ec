...
theory MultiplicationGate.
  ...
  clone import MultiplicationFunctionality.
...
(*  pred input_pred (x_fx : inputs_t * GateFunctionality.input_t) = 
  ...
  clone import Gate with
    ...
    type GateFunctionality.pinput_t = MultiplicationFunctionality.GateFunctionality.pinput_t,
    type GateFunctionality.sinput_t = MultiplicationFunctionality.GateFunctionality.sinput_t,
    op GateFunctionality.valid_inputs = MultiplicationFunctionality.GateFunctionality.valid_inputs,
    type GateFunctionality.output_t = MultiplicationFunctionality.GateFunctionality.output_t,
    op GateFunctionality.f = MultiplicationFunctionality.GateFunctionality.f,
