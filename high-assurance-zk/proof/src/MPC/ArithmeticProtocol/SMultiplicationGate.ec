...
theory SMultiplicationGate.

  clone import SMultiplicationFunctionality.
  ...
  op local_output (pid : pid_t) (v : view_t) : output_t =
    let (x,r,tr) = v in
    let (ys, ims) = tr in
    let yi = local_output_share pid x r ims in
...
(*  pred input_pred (x_fx : inputs_t * GateFunctionality.input_t) = 
  ...
  clone import Gate with
    ...
    type GateFunctionality.pinput_t = SMultiplicationFunctionality.GateFunctionality.pinput_t,
    type GateFunctionality.sinput_t = SMultiplicationFunctionality.GateFunctionality.sinput_t,
    op GateFunctionality.valid_inputs = SMultiplicationFunctionality.GateFunctionality.valid_inputs,
    type GateFunctionality.output_t = SMultiplicationFunctionality.GateFunctionality.output_t,
    op GateFunctionality.f = SMultiplicationFunctionality.GateFunctionality.f,
