...
from RAMProver require import RAMLPZKFasterProver.
...
theory PRAMProver.
  ...
  clone import MapReduce with
    ...
    type FunctionalRAM.state_t = RAMLPZKFasterProver.RAMProver.state_t,
    op FunctionalRAM.empty_state = RAMLPZKFasterProver.RAMProver.empty_state,
    op FunctionalRAM.init_state = RAMLPZKFasterProver.RAMProver.init_state,
    op FunctionalRAM.set_input = RAMLPZKFasterProver.RAMProver.set_input,
    op FunctionalRAM.step = RAMLPZKFasterProver.RAMProver.step,
    op FunctionalRAM.get_input = RAMLPZKFasterProver.RAMProver.get_input,
    op FunctionalRAM.get_output = RAMLPZKFasterProver.RAMProver.get_output,
    op FunctionalRAM.get_circuit = RAMLPZKFasterProver.RAMProver.get_circuit,
    op FunctionalRAM.has_input = RAMLPZKFasterProver.RAMProver.has_input,
    op FunctionalRAM.has_output = RAMLPZKFasterProver.RAMProver.has_output,
    op FunctionalRAM.has_circuit = RAMLPZKFasterProver.RAMProver.has_circuit,
