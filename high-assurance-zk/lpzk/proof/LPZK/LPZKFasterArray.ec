...
print gen_z.
 ...
 (** Gets the random [a] value from the prover randomness, i.e., gets the [a] random value
  ...
  proof.
    ...
    elim st => c inst /=.
    elim c => topo gg /=.
    rewrite /LPZKFasterArray.def_ui /LPZKFasterArray.def_yi /LPZKFasterArray.get_a /= 
            /LPZKFasterArray.prove /=.
    progress. congr.
  ...
  proof.
    ...
    elim: z gg => //=.
      ...
      move => gid zi zl zr; progress.
        ...
        by rewrite /LPZKFasterArray.def_yi /= /def_yi /=; congr; smt(nth_to_list get_of_list).
    qed.
  ...
  section Soundness.
    ...
    proof.
      ...
      (if => //=; last by wp); progress.
        ...
        progress.
        move : (H2 k); rewrite H0 H1 /= /LPZKFasterArray.def_yi /= /def_yi /= 
                               /LPZKFasterArray.def_ui /= /def_ui /=.
        by progress; rewrite of_listK. 
        move : H; rewrite /valid_rand_verifier /= !size_of_list !get_of_list.
        progress.
        move : (H3 k); rewrite H0 H1 /= /LPZKFasterArray.def_yi /= /def_yi /= 
                               /LPZKFasterArray.def_ui /= /def_ui /=.
        by progress; rewrite of_listK. 
        by move : H; rewrite /valid_rand_verifier /=; rewrite !size_of_list !size_to_list.
        move : H H1.
        ...
        progress. move : (H1 k).
        by rewrite H0 H3 /= !get_of_list /LPZKFasterArray.def_yi /= /def_yi /= 
                   /LPZKFasterArray.def_ui /= /def_ui /= !of_listK.
        move : H H1.
        rewrite /valid_rand_verifier /= !size_of_list !size_to_list.
        progress. move : (H2 k).
        by rewrite H0 H3 /= !get_of_list /LPZKFasterArray.def_yi /= /def_yi /= 
  ...
  clone import DVNIZKZeroKnowledge.ZeroKnowledge as LPZKFasterArrayZeroKnowledge with
    theory DVNIZKProtocol <- DVNIZKProtocol.
