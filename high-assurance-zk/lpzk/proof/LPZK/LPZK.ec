  ...
  section Soundness.
    ...
    proof.
      ...
      case ((nth def_ui rp{hr} (max_wire + 1)).`b = fzero); progress.
        ...
        case ((nth def_ui rp{hr} (max_wire + 1)).`a = n); progress; first by rewrite mu0_false; progress; smt(@PrimeField).
      ...
      case ((nth def_ui rp{hr} (max_wire + 1)).`a = n); progress.
        case (m = fzero); progress.
          by rewrite mu0_false; smt(@PrimeField).
        rewrite /m.
        ...
        by rewrite mu0_false; progress; smt(@PrimeField).
