...
module WeakPrivate
         ...
         (SMGED : sig include SMultiplicationGateEvalData with type pid_t = SSD.pid_t and
                                                               ...
                                                               type output_t = SSD.secret_t and
                                                               type poutput_t = SSD.share_t end)
         (SGD : sig include GateData with type pid_t = SSD.pid_t and type pinput_t = unit and type sinput_t = SSD.share_t and type poutput_t = SSD.share_t and type output_t = SSD.secret_t end) = Protocol (WeakPrivacyComposition (SSD) (AGED) (MGED) (SMGED) (SGD))
