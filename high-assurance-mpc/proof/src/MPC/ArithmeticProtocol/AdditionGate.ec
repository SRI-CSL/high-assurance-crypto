...
theory AdditionGate.
  ...
  clone import AdditionFunctionality with theory SecretSharingScheme <- SecretSharingScheme.
  ...
  clone import Gate with
    ...
    type GateFunctionality.pinput_t = AdditionFunctionality.pinput_t,
    type GateFunctionality.sinput_t = AdditionFunctionality.sinput_t,
    op GateFunctionality.valid_inputs = AdditionFunctionality.valid_inputs,
    type GateFunctionality.output_t = AdditionFunctionality.output_t,
    op GateFunctionality.f = AdditionFunctionality.f,
