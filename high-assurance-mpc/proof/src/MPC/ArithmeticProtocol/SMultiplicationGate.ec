...
theory SMultiplicationGate.
  ...
  clone import SMultiplicationFunctionality with theory SecretSharingScheme <- SecretSharingScheme.
  ...
  clone import Gate with
    ...
    type GateFunctionality.pinput_t = SMultiplicationFunctionality.pinput_t,
    type GateFunctionality.sinput_t = SMultiplicationFunctionality.sinput_t,
    op GateFunctionality.valid_inputs = SMultiplicationFunctionality.valid_inputs,
    type GateFunctionality.output_t = SMultiplicationFunctionality.output_t,
    op GateFunctionality.f = SMultiplicationFunctionality.f,
