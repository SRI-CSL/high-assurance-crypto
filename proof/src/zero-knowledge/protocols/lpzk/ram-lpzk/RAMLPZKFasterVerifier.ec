(**
  Formalization of the optimized list-based LPZK verifier on top of the RAM model. Briefly, this 
...
theory RAMVerifier.
  ...
  type execution_info_t = bool * f_t.
  ...
  op step_exec (circ : circuit_t) (r : verifier_rand_t) (x : instance_t) (c : commitment_t) =
    let (z, z') = c in
    LPZKFaster.gen_f r circ.`gates z.
