...
from RAMLPZK require import RAMLPZKEfficientProver.
...
theory PRAMProver.
  ...
  clone import MapReduce with
    ...
    type FunctionalRAM.state_t = RAMLPZKEfficientProver.RAMProver.state_t,
    op FunctionalRAM.empty_state = RAMLPZKEfficientProver.RAMProver.empty_state,
    op FunctionalRAM.init_state = RAMLPZKEfficientProver.RAMProver.init_state,
    op FunctionalRAM.set_input = RAMLPZKEfficientProver.RAMProver.set_input,
    op FunctionalRAM.step = RAMLPZKEfficientProver.RAMProver.step,
    op FunctionalRAM.get_input = RAMLPZKEfficientProver.RAMProver.get_input,
    op FunctionalRAM.get_output = RAMLPZKEfficientProver.RAMProver.get_output,
    op FunctionalRAM.get_circuit = RAMLPZKEfficientProver.RAMProver.get_circuit,
    op FunctionalRAM.has_input = RAMLPZKEfficientProver.RAMProver.has_input,
    op FunctionalRAM.has_output = RAMLPZKEfficientProver.RAMProver.has_output,
    op FunctionalRAM.has_circuit = RAMLPZKEfficientProver.RAMProver.has_circuit,
